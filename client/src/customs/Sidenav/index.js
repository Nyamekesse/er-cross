...
import SidenavItem from "customs/Sidenav/SidenavItem";

// Custom styles for the Sidenav
import SidenavRoot from "customs/Sidenav/SidenavRoot";
import sidenavLogoLabel from "customs/Sidenav/styles/sidenav";
    ...
    <SidenavRoot {...rest} variant="permanent" ownerState={{ darkSidenav, miniSidenav, layout }}>
      <CustomBox pt={3} pb={1} px={4} textAlign="center">
        ...
        <CustomBox component={NavLink} to="/" display="flex" alignItems="center">
          {brand && <CustomBox component="img" src={brand} alt="Logo" width="2rem" mr={0.25} />}
          <CustomBox
            width={!brandName && "100%"}
