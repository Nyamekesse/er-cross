...
import DefaultNavbarLink from "customs/Navbars/DefaultNavbar/DefaultNavbarLink";
import DefaultNavbarMobile from "customs/Navbars/DefaultNavbar/DefaultNavbarMobile";
...
function DefaultNavbar({ brand, transparent, light, action }) {
  ...
  return (
    <Container>
      ...
      >
        <CustomBox display="flex" justifyContent="space-between" alignItems="center" px={2}>
          <CustomBox component={Link} to="/" py={transparent ? 1.5 : 0.75} lineHeight={1}>
